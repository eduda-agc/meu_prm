...
robot_cam_bridge = Node(
    ...
    name="ros_gz_bridge_robot_cam",
    arguments=[
        "/world/collision_test/model/prm_robot/link/base_link/sensor/robot_cam/image@sensor_msgs/msg/Image@ignition.msgs.Image"
    ],
    remappings=[
        ("/world/collision_test/model/prm_robot/link/base_link/sensor/robot_cam/image", "/robot_cam/colored_map")
    ],
    output="screen",
)
